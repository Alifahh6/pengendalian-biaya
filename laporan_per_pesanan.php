...
<h3 class="mb-3">Laporan Biaya Langsung Per Pesanan</h3>
<div class="card p-3 mb-4">
<div class="table-responsive">
<table class="table table-bordered table-striped">
  <thead><tr><th>Nomor</th><th>Produk</th><th>JmlPesanan</th><th>Kelompok</th><th>JumlahBiaya</th></tr></thead>
  <tbody>
<?php
$sql = "SELECT A.NomorPesanan, JenisProduk, JmlPesanan, Kelompok, SUM(Jumlah) AS JumlahBiaya
         ...
         ORDER BY A.NomPesanan, JenisProduk, JmlPesanan, Kelompok";
// Note: ORDER alias (A.NomorPesanan) used in display; avoid typo 'ANomPesanan' in string above
$sql = "SELECT A.NomorPesanan, JenisProduk, JmlPesanan, Kelompok, 
       SUM(Jumlah) AS JumlahBiaya
FROM KartuPesanan A 
INNER JOIN RincianBiaya B
    ON A.NomorPesanan = B.NomorPesanan
GROUP BY A.NomorPesanan, JenisProduk, JmlPesanan, Kelompok
